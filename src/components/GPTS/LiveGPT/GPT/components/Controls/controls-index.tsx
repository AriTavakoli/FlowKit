...
import { useLiveGpt } from '../../Context/LiveGptContext';
...
const Controls = () => {
  ...
  const { handleNewResponse, handleStorageItem, handleRefreshStorage, save, savedRetries, handleCurrentResponse, currentResponseMode, index, setIndex, } = useLiveGpt();
    ...
    <>
      <div className={'control__container'}>
        ...
        <div className = "button__container">
          ...
          <RippleButton shape="square" dot={false} outlineColor="none" text="BEM" callBack={handleLeftArrowClick}  padding = '12px'>
          ...
          <RippleButton shape="square" dot={false} outlineColor="none" text="BEM" callBack={handleRightArrowClick}  padding = '12px'>
