...
function ChatGPTCard(props: Props) {
  ...
  // }
  if (triggered) {
    return <ChatGPTQuery question={props.question} sequenceRef={props.sequenceRef} onStatusChange={props.onStatusChange} executeCurrentSequence={props.executeCurrentSequence} />
  }
  return (
