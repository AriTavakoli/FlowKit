...
import { NodeAnalysis } from "@src/components/GPTS/LiveGPT/classes/NodeAnalysis";
import { useSequenceController } from "@src/components/Sequence/Context/SequenceContext";

const SequenceFieldsModal = ({ data, handleQuery, templateData, setIsVisible, isVisible, sequenceRef }) => {
        ...
        switch (element.type) {
          ...
          case 'DIV':
            ...
            if (sequenceOutputField) {
              // Set the default value for inputType 'sequenceOutput'
              const defaultValue = getOutputVar(sequenceRef.getParentId());
  ...
  return (
    <div className={styles["Field__container"]} ref={queryModalRef} onKeyDown={handleEnterKey}>
      <div className={styles["toolbar-top"]}>
        ...
        <span className={styles["toolbar--center"]}>Current Model:   </span>
...
export default SequenceFieldsModal;