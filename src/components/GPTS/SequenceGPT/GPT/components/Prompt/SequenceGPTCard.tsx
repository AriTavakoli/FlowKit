...
import SequenceGPTQuery, { QueryStatus } from './SequenceGPTQuery'
...
function SequenceGPTCard(props: Props) {
  ...
  // }
  if (triggered) {
    return <SequenceGPTQuery question={props.question} sequenceRef={props.sequenceRef} onStatusChange={props.onStatusChange} />
  }
  return (
...
export default SequenceGPTCard
