  ...
  return (
    <>
      <div
        ...
        style={{ width: mode === 'flow' ? '100vw' : undefined, height: mode === 'flow' ? '100vh' : undefined }}
      >
  ...
  return (
    <>
      <div style={currentStyle}>
        {mode === 'code' &&
          (<div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: '12px', position: 'absolute', top: '4px', left: '8px', zIndex: '200000000000000', gap: '12px' }}>
